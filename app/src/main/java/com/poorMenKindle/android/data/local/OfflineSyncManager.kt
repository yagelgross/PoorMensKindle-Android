...
object OfflineSyncManager {
    ...
    suspend fun downloadBookFull(
        ...
        try {
            ...
            val fullBookDetails = NetworkManager.api.getBook(bookId).body()
            val summary = fullBookDetails?.summary
            val seriesName = fullBookDetails?.series_name
            val seriesNumber = fullBookDetails?.series_number
